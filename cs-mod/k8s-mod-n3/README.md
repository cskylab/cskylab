...
Machine `k8s-mod-n3` is deployed from template Ubuntu server 20.04 kubernetes node version 22-03-23.
...
| `machine.hostname`           | hostname                                         | `k8s-mod-n3`                                  |
...
| `machine.ipaddress`          | main IP address                                  | `192.168.82.13`                                 |
