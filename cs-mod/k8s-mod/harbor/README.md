...
Configuration files are deployed from template Harbor opensource registry version 21.11.07.
...
Your dockerhub proxy repository is now accesible via 'harbor.cskylab.net/dockerhub'
