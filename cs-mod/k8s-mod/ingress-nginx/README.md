...
Configuration files are deployed from template Ingress nginx controller for Kubernetes. version 21.11.07.
...
| ----------------------------- | ------------------------ | ------------------------------------ |
| `_tplname`                    | template name            | `cs-ingress-nginx`                    |
| `_tpldescription`             | template description     | `Ingress nginx controller for Kubernetes.`             |
| `_tplversion`                 | template version         | `21.11.07`                 |
