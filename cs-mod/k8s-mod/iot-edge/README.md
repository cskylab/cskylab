...
## k8s-iot-edge v23-11-24 <!-- omit in toc -->
...
| ------------------------------- | ---------------------------- | ------------------------------- |
| `/srv/iot-edge-shard1` | `k8s-mod-n1` | `k8s-mod-n2` |
...
&& echo \
&& scp ./node-red-settings.js kos@k8s-mod-n1.cskylab.net:/srv/iot-edge-shard1/data/iot-edge/node-red/settings.js \
&& scp ./node-red_env.js kos@k8s-mod-n1.cskylab.net:/srv/iot-edge-shard1/data/iot-edge/node-red/node-red_env \
&& echo \
&& echo "******** END of snippet execution ********" \
&& echo
```
...
```
>Note: Script `cs-source-rsync-ab-mode.sh` must exist in host k8s-mod-n1
...
>Note: Script `cs-source-restic.sh` must exist in host k8s-mod-n1
