...
Configuration files are deployed from template MinIO standalone version 21.11.24.
...
| ----------------------------- | ------------------------------------------------ | ------------------------------------ |
| `_tplname`                    | template name                                    | `cs-miniostalone`                    |
| `_tpldescription`             | template description                             | `MinIO standalone`             |
| `_tplversion`                 | template version                                 | `21.11.24`                 |
