...
## Helm charts: nextcloud/nextcloud v3.0.4 bitnami/mariadb v11.1.8 <!-- omit in toc -->

[Nextcloud](https://nextcloud.com/) is a file sharing server that puts the control and security of your own data back into your hands.

Configuration files are deployed from template Kubernetes nextcloud namespace version 22-08-21.
...
- Published at: `nextcloud.mod.cskylab.net`
- Username: `admin`
- Password: `NoFear21`
...
- Root URL: <https://nextcloud.mod.cskylab.net>
- Save
...
- Root URL: <https://nextcloud.mod.cskylab.net>
- Valid Redirect URIs: *
- Web Origins: <http://nextcloud.mod.cskylab.net/*>
- Save
