# k8s-pro-master <!-- omit in toc -->

[comment]: <> (**Machine functional description goes here**)

Machine `k8s-pro-master` is deployed from template Ubuntu server 20.04 kubernetes node version 21.12.20.
...
| `machine.hostname`           | hostname                                         | `k8s-pro-master`                                  |
...
| `machine.ipaddress`          | main IP address                                  | `192.168.83.10`                                 |
