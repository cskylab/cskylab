...
Machine `k8s-pro-n2` is deployed from template Ubuntu server 20.04 kubernetes node version 22-03-23.
...
If ssh key has not been injected before, you must provide the password for username `kos@k8s-pro-n2` twice:
...
To run scripts and operate from inside the machine, establish an ssh connection with administrator (sudoer) user name `kos@k8s-pro-n2`.
...
| `machine.hostname`           | hostname                                         | `k8s-pro-n2`                                  |
...
| `machine.ipaddress`          | main IP address                                  | `192.168.83.12`                                 |
| `machine.netmask`            | netmask                                          | `24`                                   |
| `machine.gateway4`           | default gateway                                  | `192.168.83.1`                                  |
| `machine.searchdomainnames`  | search domain names                              | `cskylab.net, ` |
| `machine.nameservers`        | name servers IP addresses                        | `192.168.83.1, `       |
