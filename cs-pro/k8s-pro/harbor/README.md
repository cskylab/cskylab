...
Configuration files are deployed from template Harbor opensource registry version 23-11-24.
...
Your dockerhub proxy repository is now accesible via 'harbor.pro.cskylab.net/dockerhub'
