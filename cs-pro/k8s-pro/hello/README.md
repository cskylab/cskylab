...
Configuration files are deployed from template Kubernetes hellow world app version 21.11.22.
...
- Published at: `mycloud.cskylab.com`
...
| `_tplversion`               | template version                                 | `21.11.22`               |
| `kubeconfig`                | kubeconfig file                                  | `config-k8s-pro`                |
| `namespace.name`            | namespace name                                   | `hello`            |
| `namespace.domain`          | domain name                                      | `cskylab.net`          |
| `publishing.url`            | external URL                                     | `mycloud.cskylab.com`            |
