...
- API URL: `miniostalone.pro.cskylab.net`
...
| ---------------------------- | ---------------------------- | ------------------------------- |
| `/srv/miniostalone` | `k8s-pro-n1` | `k8s-pro-n2` |
...
# 0 8-23 * * *     root run-one cs-lvmserv.sh -q -m snap-remove -d /srv/miniostalone >> /var/log/cs-rsync.log 2>&1 ; run-one cs-rsync.sh -q -m rsync-to -d /srv/miniostalone -t k8s-pro-n2.cskylab.net  >> /var/log/cs-rsync.log 2>&1
```
