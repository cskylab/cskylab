# kvm-main <!-- omit in toc -->

[comment]: <> (**Machine functional description goes here**)

Machine `kvm-main` is deployed from template Ubuntu server 20.04 kvm base installation version 21.12.19.
...
| `machine.hostname`           | hostname                                         | `kvm-main`                                  |
...
| `machine.ipaddress`          | main IP address                                  | `192.168.80.10`                                 |
