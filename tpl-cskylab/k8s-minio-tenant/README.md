...
## Helm charts: minio/tenant v4.4.3 <!-- omit in toc -->

Once a [MinIO Operator](https://github.com/minio/operator) is successfully installed, you can create a MinIO Tenant in Kubernetes.
