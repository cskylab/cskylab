...
This machine runs Bind 9 DNS Services on Ubuntu Server 24.04 LTS.
...
&& export RB_MACHINE_NAME="ubt2404srv-dns" \
&& export RB_TEMPLATE="${RB_REPO_DIR}/tpl-cskylab/ubt2404srv-dns" \
&& echo
```
