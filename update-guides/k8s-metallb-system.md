...
- [v23-11-24](#v23-11-24)
  ...
  - [How-to guides](#how-to-guides-2)
    ...
    - [2.- Rename old configuration directory](#2--rename-old-configuration-directory-2)
    - [3.- Create new configuration from new template](#3--create-new-configuration-from-new-template-2)
...
- [v23-04-27](#v23-04-27)
  ...
  - [How-to guides](#how-to-guides-3)
    ...
    - [2.- Rename old configuration directory](#2--rename-old-configuration-directory-3)
    - [3.- Create new configuration from new template](#3--create-new-configuration-from-new-template-3)
...
- [v22-08-21](#v22-08-21)
  ...
  - [How-to guides](#how-to-guides-5)
    ...
    - [4.- Install new metallb-namespace](#4--install-new-metallb-namespace-5)
    - [5.- Configure IP address pools](#5--configure-ip-address-pools-5)
  - [Reference](#reference-5)
- [v22-03-23](#v22-03-23)
  - [Background](#background-6)
  - [How-to guides](#how-to-guides-6)
    - [1.- Uninstall metallb-system namespace](#1--uninstall-metallb-system-namespace-6)
    - [2.- Rename old configuration directory](#2--rename-old-configuration-directory-6)
    - [3.- Create new configuration from new template](#3--create-new-configuration-from-new-template-6)
...
In this release, MetalLB configuration template has been changed from MetalLB manifest 0.14.4 to version 0.14.8
...
In this release, MetalLB configuration template has been changed from MetalLB manifest 0.13.9 to version 0.13.12.
...
In this release, MetalLB configuration template has been changed from MetalLB manifest 0.13.7 to version 0.13.9.
...
In this release, MetalLB configuration template has been changed from MetalLB manifest 0.13.4 to version 0.13.7.
