...
- [v23-11-24](#v23-11-24)
  ...
  - [How-to guides](#how-to-guides-2)
    - [1.- Update minio-tenant manifest and documentation](#1--update-minio-tenant-manifest-and-documentation-2)
    - [2.- Update minio-operator chart](#2--update-minio-operator-chart-2)
    - [3.- Update minio-operator namespace](#3--update-minio-operator-namespace-2)
    - [4.- Update minio-tenant namespace](#4--update-minio-tenant-namespace-2)
  - [Reference](#reference-2)
- [v23-04-27](#v23-04-27)
  - [Background](#background-3)
  - [How-to guides](#how-to-guides-3)
    - [1.- Update minio-tenant manifest and documentation](#1--update-minio-tenant-manifest-and-documentation-3)
...
- [v22-12-19](#v22-12-19)
  ...
  - [How-to guides](#how-to-guides-4)
    ...
    - [2.- Update minio-operator chart](#2--update-minio-operator-chart-3)
    - [3.- Update minio-operator namespace](#3--update-minio-operator-namespace-3)
    - [4.- Update minio-tenant namespace](#4--update-minio-tenant-namespace-3)
...
``` bash
## 99-99-99 <!-- omit in toc -->

## Helm charts: minio/operator v6.0.4 <!-- omit in toc -->
```
...
``` bash
## 24-04-20 <!-- omit in toc -->

## Helm charts: minio/operator v5.0.14 <!-- omit in toc -->
```
