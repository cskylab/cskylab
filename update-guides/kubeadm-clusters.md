...
- [v23-11-24 (k8s v1.28.x-00)](#v23-11-24-k8s-v128x-00)
  - [Prerequisites](#prerequisites-3)
    ...
    - [Change kubernetes package repository](#change-kubernetes-package-repository-3)
...
- [v22-08-21](#v22-08-21)
  ...
  - [Upgrading k8s worker nodes](#upgrading-k8s-worker-nodes-7)
    - [Drain the node](#drain-the-node-7)
    - [Upgrade the node](#upgrade-the-node-7)
    - [Uncordon the node](#uncordon-the-node-7)
  - [Upgrade mcc management station](#upgrade-mcc-management-station-7)
...
- [v22-01-05](#v22-01-05)
  ...
  - [List available kubeadm versions](#list-available-kubeadm-versions-9)
  - [Upgrading k8s master node](#upgrading-k8s-master-node-9)
  - [Upgrading k8s worker nodes](#upgrading-k8s-worker-nodes-9)
    - [Drain the node](#drain-the-node-9)
    - [Upgrade the node](#upgrade-the-node-9)
    - [Uncordon the node](#uncordon-the-node-9)
  - [Upgrade mcc management station](#upgrade-mcc-management-station-9)
    - [Update mcc configuration](#update-mcc-configuration-9)
    - [Connect with mcc](#connect-with-mcc-9)
    - [Inject \& Deploy configuration to mcc](#inject--deploy-configuration-to-mcc-9)
