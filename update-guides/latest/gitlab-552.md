# gitlab chart 5.5.2 Upgrade <!-- omit in toc -->
...
GitLab chart 5.5.2 implements appVersion 14.5.2. In this version `gitlab-task-runner` pod must be renamed to `gitlab-toolbox`.
